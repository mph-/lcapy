...
class LcapyDeprecationWarning(DeprecationWarning):
    ...
    def __init__(self, value=None, feature=None, last_supported_version=None,
        ...
        if not feature:
            raise ValueError("feature is required argument of LcapyDeprecationWarning")

        if not deprecated_since_version:
            raise ValueError("deprecated_since_version is a required argument of LcapyDeprecationWarning")
