...
\begin{figure}[!h]
  \centering
  \input{figs/TFptst.pgf}
  \caption{Two-winding ideal transformer.}
  \end{figure}
...
\begin{align}
  I_1 = & \; -I_s, \\
  I_2 = & \; I_s, \\
  I_3 = & \; \frac{T_s}{T_p} I_s, \\
  I_4 = & \; -\frac{T_s}{T_p} I_s, \\
\end{align}
%
and the voltage equation is
%
\begin{align}
  V_1 - V_2 = & \; \frac{T_s}{T_p} \encp{V_3 - V_4}.
\end{align}
%
This can be expressed as
%
\begin{align}
  V_1 - V_2 - \frac{T_s}{T_p} V_3 + \frac{T_s}{T_p} V_4 = & \; 0, \\
\end{align}
...
\begin{figure}[!h]
  \centering
  \input{figs/TFptstt.pgf}
  \caption{Three-winding ideal transformer.}
\end{figure}
...
\begin{align}
  ...
  I_3 = & \; -I_{s1}, \\
  I_4 = & \; I_{s1}, \\
  I_5 = & \; \frac{T_{s2}}{T_p} I_{s2} + \frac{T_{s1}}{T_p} I_{s1}, \\
  I_6 = & \; -\frac{T_{s2}}{T_p} I_{s2} - \frac{T_{s1}}{T_p} I_{s1},
\end{align}
%
and the voltage equations are
%
\begin{align}
  V_1 - V_2 = & \; \frac{T_{s2}}{T_p} \encp{V_5 - V_6}, \\
  V_3 - V_4 = & \; \frac{T_{s1}}{T_p} \encp{V_5 - V_6}.
\end{align}
%
These can be expressed as
%
\begin{align}
  V_1 - V_2 - \frac{T_{s2}}{T_p} V_5 + \frac{T_{s2}}{T_p} V_6 = & \; 0, \\
  V_3 - V_4 - \frac{T_{s1}}{T_p} V_5 + \frac{T_{s1}}{T_p} V_6 = & \; 0.
\end{align}
...
\begin{equation}
  \begin{bmatrix}
    ...
    &  &  &  &  &  & \alpha_1 & \alpha_2  \\
    &  &  &  &  &  & -\alpha_1 & -\alpha_2  \\
  1 & -1 & 0 &  0 & -\alpha_1 & \alpha_1 & 0 & 0 \\
  0 &  0 & 1 & -1 & -\alpha_2 & \alpha_2 & 0 & 0 \\
  \end{bmatrix}
  \begin{bmatrix}
    V_1 \\ V_2 \\ V_3 \\ V_4 \\ V_5 \\ V_6 \\ I_{s1} \\ I_{s2}
  \end{bmatrix}
=
\begin{bmatrix}
  I_1 \\ I_2 \\ I_3 \\ I_4 \\ I_5 \\ I_6 \\ 0 \\ 0
\end{bmatrix},
\end{equation}
%
