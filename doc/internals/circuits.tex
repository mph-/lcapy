...
In the following, one-port components are specified where $\Ik$ is the
current flowing into the positive node, $k$, and $\Il$ is the current
flowing into the negative node, $l$.
...
\begin{figure}[!h]
  \centering
  \input{figs/I-stamp.pgf}
  \caption{Circuit for independent current source stamp.  Node $k$ is
    the positive node.}
\end{figure}


An independent current source with short circuit current
$\Isc$ flowing into node $\Nk$ has a stamp
%
\begin{equation}
  \begin{bmatrix}
    & \\
...
\end{equation}
%
where $I = -\Isc$ is the current produced by the source.
...
\begin{figure}[!h]
  ...
  \caption{Circuit for independent voltage source stamp.  Node $k$ is
    the positive node.}
\end{figure}
...
\end{equation}
%
Here $I_V$ is the current flowing into node $\Nk$ and out of node $\Nl$.
...
\begin{figure}[!h]
  ...
  \caption{Circuit for resistor stamp.  Node $k$ is the positive node.}
\end{figure}
...
the current through the capacitor $I_C=\Ik=-\Il$ is required to be solved,
%
\begin{equation}
  \begin{bmatrix}
     &  & 1 \\
...
%
\begin{eqnarray}
  I_{L1} & = & \frac{L_2\encp{\Vk - \Vl} - M\encp{\Vm - \Vn}}{s\encp{L_1 L_2 - M^2}} - \frac{i_{10}}{s}, \\
  I_{L2} & = & \frac{L_1\encp{\Vm - \Vn} - M\encp{\Vk - \Vl}}{s\encp{L_1 L_2 - M^2}} - \frac{i_{20}}{s}.
\end{eqnarray}
%
Defining,
%
...
%
\begin{eqnarray}
  I_{L1} & = & \frac{L_2\encp{\Vk - \Vl} - M\encp{\Vm - \Vn}}{sD} - \frac{i_{10}}{s}, \\
  I_{L2} & = & \frac{L_1\encp{\Vm - \Vn} - M\encp{\Vk - \Vl}}{sD} - \frac{i_{20}}{s}.
\end{eqnarray}
%
...
%
\begin{eqnarray}
  I'_{L1} & = & \frac{M^2\encp{\Vk - \Vl}}{sL_1 D} - \frac{M\encp{\Vm - \Vn}}{sD}, \\
  I'_{L2} & = & \frac{M^2\encp{\Vm - \Vn}}{sL_2 D} - \frac{M\encp{\Vk - \Vl}}{sD}.
\end{eqnarray}
%
...
\end{equation}
%
%% When $\Vl = \Vn = 0$, this simplifies to
%% %
%% \begin{equation}
%%   \begin{bmatrix}
%%  &  A_{21}  & A_{22}  \\
...
\end{equation}
%
%% When $\Vl = \Vm = 0$, this simplifies to
%% %
%% \begin{equation}
%%   \begin{bmatrix}
%%       & & 1 &   \\
...
%
\begin{eqnarray}
  \Il(s) & = & I_1(s) - \encp{\frac{V_1(s)}{s L_1} - \frac{i_1(0^{-})}{s}}, \\
...
%
\begin{equation}
  \Il(s) = \frac{k^2}{s L_1 \encp{1-k^2}} V_1 - \frac{k}{s\sqrt{L_1 L_2}\encp{1-k^2}}V_2.
\end{equation}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPA.pgf}
  \caption{Generalized A-parameters two-port.}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPB.pgf}
  \caption{Generalized B-parameters two-port.}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPG.pgf}
  \caption{Generalized G-parameters two-port.}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPH.pgf}
  \caption{Generalized H-parameters two-port.}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPY.pgf}
  \caption{Generalized Y-parameters two-port.}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \input{figs/TPZ.pgf}
  \caption{Generalized Z-parameters two-port.}
\end{figure}
