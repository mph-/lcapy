...
\begin{figure}[!h]
  \centering
  \input{figs/TFptstt-stamp.pgf}
  \caption{Three-winding ideal transformer defined by TF k l m n p q.}
\end{figure}
...
\end{equation}
%
where $\alpha_1 =  T_{S1} / T_p$ and $\alpha_l =  T_{S2} / T_p$.
