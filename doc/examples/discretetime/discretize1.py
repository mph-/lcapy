...
h1.plot((-10, 100), axes=axes, label='impulse-invariance', color='C0')
h2.plot((-10, 100), axes=axes, label='matched-Z', color='C1')
h3.plot((-10, 100), axes=axes, label='bilinear', color='C2')
h4.plot((-10, 100), axes=axes, label='forward-Euler', color='C3')
h5.plot((-10, 100), axes=axes, label='backward-Euler', color='C4')
axes.set_ylim(0, 1.5)
